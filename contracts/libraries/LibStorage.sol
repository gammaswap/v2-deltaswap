...
library LibStorage {
    ...
    function initialize(Storage storage self, address _factory, address _token0, address _token1) internal {
        require(self.factory == address(0), "INITIALIZED");// cannot initialize twice
