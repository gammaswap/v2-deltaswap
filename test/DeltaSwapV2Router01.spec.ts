...
enum RouterVersion {
    DeltaSwapV2Router01 = 'DeltaSwapV2Router01',
    DeltaSwapV2Router02 = 'DeltaSwapV2Router02'
}

describe('DeltaSwapV2Router{01,02}', () => {
    for (const routerVersion of Object.keys(RouterVersion)) {
        ...
        beforeEach(async function() {
            ...
            router = {
                [RouterVersion.DeltaSwapV2Router01]: fixture.router01,
                [RouterVersion.DeltaSwapV2Router02]: fixture.router02
        ...
        describe(routerVersion, () => {
            ...
            describe('swapExactTokensForTokens', () => {
                ...
                it('gas', async () => {
                    ...
                    expect(receipt.gasUsed).to.eq(
                        {
                            [RouterVersion.DeltaSwapV2Router01]: 152336, // 144244
                            [RouterVersion.DeltaSwapV2Router02]: 152425, // 144333
                        }[routerVersion as RouterVersion]
                    )
                }).retries(3)
            })
            ...
            describe('swapExactETHForTokens', () => {
                ...
                it('gas', async () => {
                    ...
                    expect(receipt.gasUsed).to.eq(
                        {
                            [RouterVersion.DeltaSwapV2Router01]: 155702, // 147610
                            [RouterVersion.DeltaSwapV2Router02]: 155641 // 147549
                        }[routerVersion as RouterVersion]
                    )
                }).retries(3)
            })
